    ...
    return (
        <div className="main-container shadow" id="bottom-bar-panel">
            <div id="song-info-container">
                <span id="bottom-bar-title" className="overflow-ellipsis prevent-select">{currentSong?.title}</span>
                <span className="overflow-ellipsis prevent-select">{currentSong?.artist}</span>
            </div>
